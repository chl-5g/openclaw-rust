...
pub trait AIPort: Send + Sync {
    async fn chat(&self, messages: Vec<openagentic_core::Message>) -> Result<String>;

    async fn chat_stream(
        &self,
        messages: Vec<openagentic_core::Message>,
...
pub trait MemoryPort: Send + Sync {
    ...
    async fn get_context(&self) -> Result<Vec<openagentic_core::Message>>;
}
