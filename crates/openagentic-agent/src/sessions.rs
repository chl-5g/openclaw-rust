...
pub trait SessionStorage: Send + Sync {
    ...
    async fn save_messages(&self, session_id: &Uuid, messages: &[openagentic_core::Message]) -> crate::Result<()>;
    async fn load_messages(&self, session_id: &Uuid) -> crate::Result<Vec<openagentic_core::Message>>;
...
impl SqliteSessionStorage {
    ...
    fn get_connection(&self) -> crate::Result<rusqlite::Connection> {
        rusqlite::Connection::open(&self.db_path)
            .map_err(|e| crate::OpenAgenticError::Session(format!("SQLite error: {}", e)))
    }
    ...
    fn init_tables(conn: &rusqlite::Connection) -> crate::Result<()> {
        conn.execute(
            ...
            [],
        ).map_err(|e| crate::OpenAgenticError::Session(format!("Failed to create table: {}", e)))?;

        conn.execute(
            "CREATE INDEX IF NOT EXISTS idx_sessions_agent_id ON sessions(agent_id)",
            [],
        ).map_err(|e| crate::OpenAgenticError::Session(format!("Failed to create index: {}", e)))?;
        ...
        conn.execute(
            ...
            [],
        ).map_err(|e| crate::OpenAgenticError::Session(format!("Failed to create messages table: {}", e)))?;

        conn.execute(
            "CREATE INDEX IF NOT EXISTS idx_session_messages_session_id ON session_messages(session_id)",
            [],
        ).map_err(|e| crate::OpenAgenticError::Session(format!("Failed to create messages index: {}", e)))?;
...
impl SessionStorage for SqliteSessionStorage {
    async fn save(&self, session: &Session) -> crate::Result<()> {
        ...
        ).map_err(|e| crate::OpenAgenticError::Session(e.to_string()))?;
    ...
    async fn load(&self, id: &Uuid) -> crate::Result<Option<Session>> {
        ...
        match result {
            ...
            Err(e) => Err(crate::OpenAgenticError::Session(e.to_string())),
        }
    }
    ...
    async fn load_messages(&self, session_id: &Uuid) -> crate::Result<Vec<openagentic_core::Message>> {
        ...
        let messages = stmt.query_map([session_id.to_string()], |row| {
            use openagentic_core::message::Role as MsgRole;
            use openagentic_core::Content;
            use openagentic_core::message::MessageMetadata;
...
impl SessionStorage for MemorySessionStorage {
    ...
    async fn save_messages(&self, _session_id: &Uuid, _messages: &[openagentic_core::Message]) -> crate::Result<()> {
        Ok(())
    }

    async fn load_messages(&self, _session_id: &Uuid) -> crate::Result<Vec<openagentic_core::Message>> {
        Ok(Vec::new())
    }
...
impl SessionManager {
    ...
    pub async fn close_session(&self, id: &Uuid) -> crate::Result<()> {
        let mut session = self
            .get_session(id)
            .await?
            .ok_or_else(|| crate::OpenAgenticError::Session(format!("Session {} not found", id)))?;
