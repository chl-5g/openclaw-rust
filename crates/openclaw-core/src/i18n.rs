...
static TRANSLATIONS: Lazy<RwLock<HashMap<String, HashMap<String, String>>>> = Lazy::new(|| {
    ...
    zh.insert("welcome".into(), "欢迎使用 OpenClaw".into());
    ...
    en.insert("welcome".into(), "Welcome to OpenClaw".into());
...
mod tests {
    ...
    fn test_i18n_english() {
        ...
        assert_eq!(I18n::t(&locale, "welcome"), "Welcome to OpenClaw");
    ...
    fn test_i18n_chinese() {
        ...
        assert_eq!(I18n::t(&locale, "welcome"), "欢迎使用 OpenClaw");
    ...
    fn test_all_translations() {
        ...
        assert_eq!(translations.get("welcome"), Some(&"Welcome to OpenClaw".to_string()));
    }
}
