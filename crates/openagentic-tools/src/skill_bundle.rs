...
pub struct BundleManifest {
    ...
    /// 兼容的 OpenAgentic 版本
    pub openagentic_version: Option<String>,
    /// 创建时间
...
impl WorkspaceSkillsConfig {
    ...
    pub fn load(workspace_path: &Path) -> Result<Self, BundleError> {
        let config_path = workspace_path.join(".open-agentic").join("skills.json");
    ...
    pub fn save(&self) -> Result<(), BundleError> {
        let config_dir = self.workspace_path.join(".open-agentic");
...
impl BundleManager {
    ...
    pub fn new(platform: Arc<SkillPlatform>, bundles_dir: PathBuf) -> Self {
        Self {
            ...
            marketplace_url: "https://market.openagentic.ai/api/v1".to_string(),
        }
    }
    ...
    fn get_fallback_entries(&self, query: &str) -> Vec<MarketplaceEntry> {
        ...
        let all_entries = vec![
            MarketplaceEntry {
                id: "openagentic/web-scraper".to_string(),
                name: "Web Scraper".to_string(),
                version: "1.0.0".to_string(),
                description: "网页抓取技能包".to_string(),
                author: "OpenAgentic Team".to_string(),
                downloads: 1500,
                rating: 4.8,
                tags: vec!["web".to_string(), "scraping".to_string()],
                download_url: "https://market.openagentic.ai/bundles/web-scraper".to_string(),
                docs_url: Some("https://docs.openagentic.ai/skills/web-scraper".to_string()),
            },
            MarketplaceEntry {
                id: "openagentic/code-assistant".to_string(),
                ...
                download_url: "https://market.openagentic.ai/bundles/code-assistant".to_string(),
                docs_url: Some("https://docs.openagentic.ai/skills/code-assistant".to_string()),
            },
            MarketplaceEntry {
                id: "openagentic/data-analysis".to_string(),
                ...
                download_url: "https://market.openagentic.ai/bundles/data-analysis".to_string(),
                docs_url: Some("https://docs.openagentic.ai/skills/data-analysis".to_string()),
            },
            MarketplaceEntry {
                id: "openagentic/image-processor".to_string(),
                ...
                download_url: "https://market.openagentic.ai/bundles/image-processor".to_string(),
                docs_url: Some("https://docs.openagentic.ai/skills/image-processor".to_string()),
            },
        ];
