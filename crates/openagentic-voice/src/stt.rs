...
pub trait SpeechToText: Send + Sync {
    ...
    async fn transcribe_file(
        ...
        let audio_data = std::fs::read(file_path)
            .map_err(|e| OpenAgenticError::Config(format!("读取音频文件失败: {}", e)))?;
...
impl OpenAIWhisperStt {
    ...
    fn get_api_key(&self) -> Result<String> {
        self.config
            .openai_api_key
            .clone()
            .ok_or_else(|| OpenAgenticError::Config("未配置 OpenAI API Key".to_string()))
    }
}
...
impl SpeechToText for OpenAIWhisperStt {
    ...
    async fn transcribe(
        ...
        let mut form = reqwest::multipart::Form::new()
            ...
            .part(
                ...
                reqwest::multipart::Part::bytes(audio_data.to_vec())
                    .file_name("audio.mp3")
                    .mime_str("audio/mpeg")
                    .map_err(|e| OpenAgenticError::Http(format!("创建 multipart 失败: {}", e)))?,
            );
        ...
        let response = self
            ...
            .send()
            .await
            .map_err(|e| OpenAgenticError::Http(format!("Whisper API 请求失败: {}", e)))?;
...
impl SpeechToText for AzureStt {
    ...
    async fn transcribe(
        ...
        let response = self
            ...
            .send()
            .await
            .map_err(|e| OpenAgenticError::Http(format!("Azure STT 请求失败: {}", e)))?;
...
impl SpeechToText for GoogleStt {
    ...
    async fn transcribe(
        ...
        let response = self
            ...
            .send()
            .await
            .map_err(|e| OpenAgenticError::Http(format!("Google STT 请求失败: {}", e)))?;
