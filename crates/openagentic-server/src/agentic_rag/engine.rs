...
impl AgenticRAGEngine {
    pub async fn new(
        config: AgenticRAGConfig,
        llm: Arc<dyn openagentic_ai::AIProvider>,
        memory_manager: Option<Arc<openagentic_memory::MemoryManager>>,
        vector_store: Option<Arc<dyn openagentic_vector::VectorStore>>,
        embedding_provider: Option<Arc<dyn openagentic_memory::embedding::EmbeddingProvider>>,
    ) -> Result<Self> {
