...
use openagentic_device::{DeviceInfo, UnifiedDeviceManager};
...
mod tests {
    ...
    use openagentic_device::{CameraManager, ScreenManager};
    use tower::ServiceExt;

    #[tokio::test]
    async fn test_device_api_state_creation() {
        let registry = Arc::new(openagentic_device::DeviceRegistry::new());
    ...
    async fn test_list_devices_with_multiple_devices() {
        use openagentic_device::DeviceType;
