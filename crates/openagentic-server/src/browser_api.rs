...
async fn page_scroll(
    ...
    let options = openagentic_browser::ScrollOptions {
        distance: req
            .x
            .zip(req.y)
            .map(|(x, y)| openagentic_browser::ScrollDistance { x, y }),
...
async fn page_screenshot(
    ...
    let format = match req.format.as_deref() {
        Some("jpeg") | Some("jpg") => openagentic_browser::ScreenshotFormat::Jpeg,
        Some("webp") => openagentic_browser::ScreenshotFormat::Webp,
        _ => openagentic_browser::ScreenshotFormat::Png,
    };
    ...
    let mime_type = match format {
        openagentic_browser::ScreenshotFormat::Png => "image/png",
        openagentic_browser::ScreenshotFormat::Jpeg => "image/jpeg",
        openagentic_browser::ScreenshotFormat::Webp => "image/webp",
    };
...
async fn page_pdf(
    ...
    let format = match req.format.as_deref() {
        Some("a3") => openagentic_browser::PaperFormat::A3,
        Some("a5") => openagentic_browser::PaperFormat::A5,
        _ => openagentic_browser::PaperFormat::A4,
    };
...
mod tests {
    use super::*;
    use openagentic_browser::BrowserConfig;
