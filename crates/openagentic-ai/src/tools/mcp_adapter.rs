...
impl McpClient {
    ...
    pub async fn call_tool(&self, name: &str, arguments: Value) -> Result<Value> {
        ...
        if let Some(result) = response.result {
            ...
            Err(openagentic_core::OpenAgenticError::AIProvider(
...
impl McpToolAdapter {
    ...
    pub fn from_builtin(tool: &openagentic_tools::McpBuiltinTool) -> Self {
...
impl McpToolRegistry {
    ...
    pub async fn register_all(&self, mcp_tools: &[openagentic_tools::McpBuiltinTool]) {
        let mut tools = self.tools.write().await;
    ...
    pub async fn register_builtin_tools(&self) {
        let builtin_tools = openagentic_tools::McpBuiltinTools::all();
