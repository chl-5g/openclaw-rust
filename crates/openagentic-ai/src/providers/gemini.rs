...
impl AIProvider for GeminiProvider {
    ...
    async fn chat(&self, request: ChatRequest) -> Result<ChatResponse> {
        ...
        let response = self
            ...
            .send()
            .await
            .map_err(|e| OpenAgenticError::Http(format!("Gemini API 请求失败: {}", e)))?;
    ...
    async fn chat_stream(
        ...
        let response = self
            ...
            .send()
            .await
            .map_err(|e| OpenAgenticError::Http(format!("Gemini Stream API 请求失败: {}", e)))?;
    ...
    async fn embed(&self, request: EmbeddingRequest) -> Result<EmbeddingResponse> {
        ...
        let response = self
            ...
            .send()
            .await
            .map_err(|e| OpenAgenticError::Http(format!("Gemini Embedding API 请求失败: {}", e)))?;
        ...
        async_stream::stream! {
            ...
            while let Some(bytes_result) = byte_stream.next().await {
                match bytes_result {
                    ...
                    Err(e) => {
                        yield Err(OpenAgenticError::Http(format!("Gemini 流读取错误: {}", e)));
                        return;
                    }
                }
            }
        ...
        for line in event.lines() {
            if let Some(data) = line.strip_prefix("data: ") {
                ...
                match serde_json::from_str::<serde_json::Value>(data) {
                    ...
                    Err(e) => {
                        return Some(Err(OpenAgenticError::Serialization(e)));
                    }
                }
            }
        }
