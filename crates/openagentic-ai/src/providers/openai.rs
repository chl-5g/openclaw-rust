...
impl AIProvider for OpenAIProvider {
    ...
    async fn chat(&self, request: ChatRequest) -> Result<ChatResponse> {
        ...
        let response = self
            ...
            .send()
            .await
            .map_err(|e| OpenAgenticError::Http(format!("OpenAI API 请求失败: {}", e)))?;
    ...
    async fn chat_stream(
        ...
        let response = self
            ...
            .send()
            .await
            .map_err(|e| OpenAgenticError::Http(format!("OpenAI Stream API 请求失败: {}", e)))?;
    ...
    async fn embed(&self, request: EmbeddingRequest) -> Result<EmbeddingResponse> {
        ...
        let response = self
            ...
            .send()
            .await
            .map_err(|e| OpenAgenticError::Http(format!("OpenAI Embedding API 请求失败: {}", e)))?;
        ...
        async_stream::stream! {
            ...
            while let Some(bytes_result) = byte_stream.next().await {
                match bytes_result {
                    ...
                    Err(e) => {
                        yield Err(OpenAgenticError::Http(format!("流读取错误: {}", e)));
                        return;
                    }
                }
            }
