...
impl Default for FileTrackerConfig {
    fn default() -> Self {
        Self {
            data_dir: PathBuf::from(".open-agentic/file_tracker"),
            index_file: PathBuf::from(".open-agentic/file_tracker/index.json"),
        }
    }
}
...
mod tests {
    ...
    fn test_file_tracker() {
        let temp_dir = env::temp_dir().join("openagentic_test_tracker");
