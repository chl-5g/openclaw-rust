...
use openagentic_core::{Content, Message};
use regex::Regex;
...
impl ImportanceScorer {
    ...
    pub fn score(&self, message: &Message) -> f32 {
        ...
        score += match message.role {
            openagentic_core::Role::System => 0.3,
            openagentic_core::Role::User => 0.2,
            openagentic_core::Role::Assistant => 0.15,
            openagentic_core::Role::Tool => 0.1,
        };
