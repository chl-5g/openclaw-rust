...
pub fn create_store(backend: StoreBackend) -> Result<Arc<dyn VectorStore>> {
    match backend {
        ...
        StoreBackend::SQLite { .. } => Err(OpenAgenticError::VectorStore(
