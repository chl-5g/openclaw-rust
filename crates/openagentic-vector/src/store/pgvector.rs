...
impl PgVectorStore {
    pub async fn new(connection_string: &str, table_name: &str, dimension: usize) -> Result<Self> {
        let pool = PgPool::connect(connection_string).await.map_err(|e| {
            OpenAgenticError::Config(format!("Failed to connect to PostgreSQL: {}", e))
        })?;
    ...
    async fn initialize_table(&self) -> Result<()> {
        ...
        sqlx::query(&create_table_sql)
            .execute(&self.pool)
            .await
            .map_err(|e| OpenAgenticError::Config(format!("Failed to create table: {}", e)))?;
        ...
        sqlx::query(&create_index_sql)
            .execute(&self.pool)
            .await
            .map_err(|e| OpenAgenticError::Config(format!("Failed to create index: {}", e)))?;
        ...
        sqlx::query(&create_gin_index_sql)
            .execute(&self.pool)
            .await
            .map_err(|e| OpenAgenticError::Config(format!("Failed to create GIN index: {}", e)))?;
...
impl VectorStore for PgVectorStore {
    async fn upsert(&self, item: VectorItem) -> Result<()> {
        ...
        let payload_json = serde_json::to_string(&item.payload)
            .map_err(|e| OpenAgenticError::Config(format!("Failed to serialize payload: {}", e)))?;
        ...
        sqlx::query(&sql)
            ...
            .execute(&self.pool)
            .await
            .map_err(|e| OpenAgenticError::Config(format!("Failed to upsert: {}", e)))?;
    ...
    async fn search(&self, query: SearchQuery) -> Result<Vec<SearchResult>> {
        ...
        let rows: Vec<PgRow> = sqlx::query(&sql)
            ...
            .fetch_all(&self.pool)
            .await
            .map_err(|e| OpenAgenticError::Config(format!("Failed to search: {}", e)))?;
    ...
    async fn get(&self, id: &str) -> Result<Option<VectorItem>> {
        ...
        let rows: Vec<PgRow> = sqlx::query(&sql)
            ...
            .fetch_all(&self.pool)
            .await
            .map_err(|e| OpenAgenticError::Config(format!("Failed to get: {}", e)))?;
    ...
    async fn delete(&self, id: &str) -> Result<()> {
        ...
        sqlx::query(&sql)
            ...
            .execute(&self.pool)
            .await
            .map_err(|e| OpenAgenticError::Config(format!("Failed to delete: {}", e)))?;
    ...
    async fn delete_by_filter(&self, filter: Filter) -> Result<usize> {
        ...
        let result = sqlx::query(&sql)
            .execute(&self.pool)
            .await
            .map_err(|e| OpenAgenticError::Config(format!("Failed to delete by filter: {}", e)))?;
    ...
    async fn stats(&self) -> Result<StoreStats> {
        ...
        let row: PgRow = sqlx::query(&sql)
            .fetch_one(&self.pool)
            .await
            .map_err(|e| OpenAgenticError::Config(format!("Failed to get stats: {}", e)))?;
    ...
    async fn clear(&self) -> Result<()> {
        ...
        sqlx::query(&sql)
            .execute(&self.pool)
            .await
            .map_err(|e| OpenAgenticError::Config(format!("Failed to clear: {}", e)))?;
...
impl super::factory::VectorStoreFactory for PgVectorStoreFactory {
    ...
    async fn create(&self, config: &super::factory::BackendConfig) -> Result<Arc<dyn super::VectorStore>> {
        let url = config
            .url
            .as_ref()
            .ok_or_else(|| OpenAgenticError::Config("PgVector requires url (connection_string) config".to_string()))?;
